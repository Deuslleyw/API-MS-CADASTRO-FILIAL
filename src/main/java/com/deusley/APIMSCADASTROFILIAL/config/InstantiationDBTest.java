...
public class InstantiationDBTest implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Cadastro cad1 = new Cadastro("001", "Dowglas", "29474994000201","007710",null, null);
        Cadastro cad2 = new Cadastro("007", "Diego", "29474994000202","007711", null, null);
        Cadastro cad3 = new Cadastro("0555", "joaquim", "29474994000203","007712", null, null);
